...
class RecyclerViewMatcher {
  ...
  private class LinearLayoutManagerColumnCountAssertion(expectedColumnCount: Int) : ViewAssertion {
    ...
    override fun check(view: View, noViewFoundException: NoMatchingViewException?) {
      ...
      if (recyclerView.layoutManager is LinearLayoutManager) {
        ...
        val spanCount = linearLayoutManager.itemCount
        ...
        throw IllegalStateException("no linear layout manager")
      }
    }
  }
}
